...
namespace ChessGame.Helpers
{
    public class AvailableMovesHelper : IAvailableMovesHelper
    {
        ...
        private IBoardQuery m_boardQuery;

        public AvailableMovesHelper(IBoardQuery boardQuery)
        {
            m_boardQuery = boardQuery;
        ...
        {
            if (m_boardQuery.TryGetTool(position, out ITool toolToMove))
            {
        ...
        {
            return false == m_boardQuery.TryGetTool(position, out _);
        }

        private  bool isPositionFreeOrKilling(BoardPosition positionToMove, ITool tool)
        {
            bool isPositionOccupied = m_boardQuery.TryGetTool(positionToMove, out ITool toolOnPosition);
